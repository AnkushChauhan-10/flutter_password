...
import 'package:password/features/home/presentation/widgets/account_list.dart';
import 'package:password/features/home/presentation/widgets/curve_layout/curve_layout.dart';
import 'package:password/features/home/presentation/widgets/curve_layout/layout_animation.dart';
import 'package:password/features/home/presentation/widgets/drawer.dart';
import 'package:password/features/home/presentation/widgets/home_tool_bar.dart';
...
class _HomePage extends State<HomePage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    context.read<HomeBloc>().add(const OnGetListHomeEvent());
                        ...
                        child: CurveLayout(
                          ...
                          child: RefreshIndicator(
                            ...
                            child: AccountList(
                              ...
                              onTap: () {},
                              delete: (index) {
                                context.read<HomeBloc>().add(OnDeleteAccount(index: index));
                              },
                            ),
                          ),
                        ),
